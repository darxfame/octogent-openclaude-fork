...
const readSkillMetadata = (skillFilePath) => {
    const fallbackName = basename(skillFilePath, ".md") === "SKILL"
...
const listSkillDefinitionFiles = (skillsRoot) => {
...
export const readAvailableClaudeSkills = (workspaceCwd) => {
    const roots = [
...
export const parseSuggestedSkillsFromContext = (content) => {
...
const renderSuggestedSkillsBlock = (skills) => {
...
export const applySuggestedSkillsToContext = (content, skills) => {
...
//# sourceMappingURL=claudeSkills.js.map