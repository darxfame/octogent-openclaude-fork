import { isTerminalCompletionSoundId } from "../terminalRuntime";
export const parseUiStatePatch = (payload) => {
    ...
    if (minimizedKey !== undefined) {
        ...
        const minimizedTerminalIds = minimizedKey.filter((id) => typeof id === "string");
    ...
    if (widthsKey !== undefined) {
        ...
        const terminalWidths = Object.entries(widthsKey).reduce((acc, [id, width]) => {
    ...
    if (record.canvasOpenTerminalIds !== undefined) {
        ...
        const canvasOpenTerminalIds = record.canvasOpenTerminalIds.filter((id) => typeof id === "string");
    ...
    if (record.canvasOpenTentacleIds !== undefined) {
        ...
        const canvasOpenTentacleIds = record.canvasOpenTentacleIds.filter((id) => typeof id === "string");
    ...
    if (record.terminalInactivityThresholdMs !== undefined) {
        if (typeof record.terminalInactivityThresholdMs !== "number" ||
...
//# sourceMappingURL=uiStateParsers.js.map