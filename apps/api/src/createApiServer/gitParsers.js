export const parseTentacleCommitMessage = (payload) => {
...
export const parseTentacleSyncBaseRef = (payload) => {
    ...
    const rawBaseRef = payload.baseRef;
...
export const parseTentaclePullRequestCreateInput = (payload) => {
    if (payload === null || payload === undefined || typeof payload !== "object") {
        return {
            title: null,
            body: "",
