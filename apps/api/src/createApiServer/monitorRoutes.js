...
export const handleMonitorConfigRoute = async ({ request, response, requestUrl, corsOrigin }, { monitorService }) => {
...
export const handleMonitorFeedRoute = async ({ request, response, requestUrl, corsOrigin }, { monitorService }) => {
...
export const handleMonitorRefreshRoute = async ({ request, response, requestUrl, corsOrigin }, { monitorService }) => {
