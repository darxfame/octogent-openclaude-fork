...
export const handleCodeIntelEventsRoute = async ({ request, response, requestUrl, corsOrigin }, { codeIntelStore }) => {
    ...
    if (request.method === "POST") {
        ...
        const octogentSession = typeof request.headers["x-octogent-session"] === "string" &&
            request.headers["x-octogent-session"].length > 0
            ? request.headers["x-octogent-session"]
            : undefined;
        const claudeSession = payload && typeof payload.session_id === "string" && payload.session_id.length > 0
            ? payload.session_id
            : undefined;
...
//# sourceMappingURL=codeIntelRoutes.js.map