...
export const handleCodexUsageRoute = async ({ request, response, requestUrl, corsOrigin }, { readCodexUsageSnapshot }) => {
...
export const handleClaudeUsageRoute = async ({ request, response, requestUrl, corsOrigin }, { readClaudeUsageSnapshot, readClaudeOauthUsageSnapshot, readClaudeCliUsageSnapshot }) => {
    ...
    const payload = requestUrl.pathname === "/api/claude/usage/oauth"
...
export const handleUsageHeatmapRoute = async ({ request, response, requestUrl, corsOrigin }, { scanUsageHeatmap }) => {
...
export const handleGithubSummaryRoute = async ({ request, response, requestUrl, corsOrigin }, { readGithubRepoSummary }) => {
