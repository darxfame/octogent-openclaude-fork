 ...
 */
export const interpolatePrompt = (template, variables) => template.replace(/\{\{(\w+)\}\}/g, (match, key) => variables[key] ?? match);
/**
 ...
 */
export const readPromptTemplate = async (promptsDir, name) => {
 ...
 */
export const resolvePrompt = async (promptsDir, name, variables) => {
 ...
 */
export const listPromptTemplates = async (promptsDir) => {
    try {
 ...
 */
export const listAllPrompts = async (builtinDir, userDir) => {
 ...
 */
export const readPromptFromDirs = async (builtinDir, userDir, name) => {
 ...
 */
export const writeUserPrompt = async (userDir, name, content) => {
 ...
 */
export const deleteUserPrompt = async (userDir, name) => {
    if (!VALID_PROMPT_NAME.test(name) || name.includes("..")) {
        return false;
    }
    try {
