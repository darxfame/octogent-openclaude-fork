...
const normalizeGitHubCommitPoint = (value) => {
...
const normalizeGitHubRecentCommit = (value) => {
    const record = asRecord(value);
    if (!record) {
        return null;
    }
...
export const normalizeGitHubRepoSummarySnapshot = (value) => {
    const record = asRecord(value);
    if (!record) {
        return null;
    }
...
//# sourceMappingURL=githubNormalizers.js.map