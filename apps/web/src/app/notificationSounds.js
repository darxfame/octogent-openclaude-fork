import { isTerminalCompletionSoundId } from "@octogent/core";
export { isTerminalCompletionSoundId };
export const DEFAULT_TERMINAL_COMPLETION_SOUND = "pop";
export const TERMINAL_COMPLETION_SOUND_OPTIONS = [
    {
        id: "soft-chime",
        label: "Soft chime",
...
const writeWavHeader = (buffer, payloadByteLength) => {
...
const buildStepSamples = (step) => {
    ...
    for (let sampleIndex = 0; sampleIndex < sampleCount; sampleIndex += 1) {
        ...
        const waveformValue = step.waveform === "square" ? (Math.sin(phase) >= 0 ? 1 : -1) : Math.sin(phase);
...
export const buildTerminalCompletionSoundDataUrl = (soundId) => {
...
//# sourceMappingURL=notificationSounds.js.map