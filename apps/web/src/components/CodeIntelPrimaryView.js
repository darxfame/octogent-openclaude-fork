...
export const CodeIntelPrimaryView = ({ enabled }) => {
    const { events, treemapRoot, couplingData, isLoading, error, refresh } = useCodeIntelRuntime(enabled);
    if (isLoading && events.length === 0) {
        return (<section className="code-intel-view" aria-label="Code Intel primary view">
...
//# sourceMappingURL=CodeIntelPrimaryView.js.map