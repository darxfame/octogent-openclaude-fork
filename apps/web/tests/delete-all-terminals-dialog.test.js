...
describe("DeleteAllTerminalsDialog", () => {
    ...
    it("surfaces partial failures after refreshing the parent state", async () => {
        ...
        render(<DeleteAllTerminalsDialog columns={[
                {
            ...
            ]} onCancel={vi.fn()} onDeleted={onDeleted}/>);
        ...
        expect(screen.getByRole("alert")).toHaveTextContent("Failed to delete 1 item: Tentacle A: Terminal is busy.");
    });
});
//# sourceMappingURL=delete-all-terminals-dialog.test.js.map