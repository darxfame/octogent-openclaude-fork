...
describe("CanvasTentaclePanel actions", () => {
    ...
    it("offers worktree and normal swarm options", async () => {
        ...
        render(<CanvasTentaclePanel node={{
                id: "docs-knowledge",
                type: "tentacle",
                x: 0,
                y: 0,
                ...
                color: "#ff6b2b",
            }} tentacle={tentacle} sessions={[]} onClose={() => { }} onSpawnSwarm={onSpawnSwarm}/>);
    ...
    it("spawns a dedicated agent for an individual todo item", async () => {
        ...
        render(<CanvasTentaclePanel node={{
                ...
                label: "Docs & Knowledge",
                color: "#ff6b2b",
            }} tentacle={tentacle} sessions={[]} onClose={() => { }} onSolveTodoItem={onSolveTodoItem}/>);
    ...
    it("refreshes centralized tentacle data after mutating todo items", async () => {
        ...
        render(<CanvasTentaclePanel node={{
                ...
                label: "Docs & Knowledge",
                color: "#ff6b2b",
            }} tentacle={tentacle} sessions={[]} onClose={() => { }} onRefreshTentacleData={onRefreshTentacleData}/>);
    ...
    it("shows suggested skills in the tentacle detail panel", async () => {
        render(<CanvasTentaclePanel node={{
                ...
                label: "Docs & Knowledge",
                color: "#ff6b2b",
            }} tentacle={tentacle} sessions={[]} onClose={() => { }}/>);
...
//# sourceMappingURL=canvas-tentacle-panel.test.js.map