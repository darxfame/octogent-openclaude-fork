...
describe("HttpTerminalSnapshotReader", () => {
    ...
    it("throws when API response is not ok", async () => {
        ...
        await expect(reader.listTerminalSnapshots()).rejects.toThrow("Unable to load terminal snapshots (503)");
    });
});
//# sourceMappingURL=HttpTerminalSnapshotReader.test.js.map